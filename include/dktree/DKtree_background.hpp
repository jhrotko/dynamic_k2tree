...
#define R 8
    ...
    class DKtree_background : public Graph<
            DKtreeEdgeIterator<DKtree_background<k, t_bv, t_rank, l_rank>, k2_tree<k, t_bv, t_rank, l_rank>, edge_iterator<k2_tree<k, t_bv, t_rank, l_rank>>>,
            DKtreeNodeIterator<DKtree_background<k, t_bv, t_rank, l_rank>>,
            DKtreeNeighbourIterator<DKtree_background<k, t_bv, t_rank, l_rank>, k2_tree<k, t_bv, t_rank, l_rank>, neighbour_iterator<k2_tree<k, t_bv, t_rank, l_rank>>, Container0, Container0NeighIterator<Container0>>> {
        ...
        using dktree_neighbour_it = DKtreeNeighbourIterator<DKtree_background<k, t_bv, t_rank, l_rank>, k_tree, k_tree_neighbour_it, Container0, Container0NeighIterator<Container0>>;
    private:
        uint max_r = 0;
    ...
    public:
        ...
        ~DKtree_background() {
            if(background_union.joinable())
                background_union.join();
        }

        DKtree_background(uint n_vertices) : n_vertices(n_vertices), background_union() {
