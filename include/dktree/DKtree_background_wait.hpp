#ifndef __D_K_TRSIZEEE_BACKGRSIZEOUND_WAIT__
#define __D_K_TRSIZEEE_BACKGRSIZEOUND_WAIT__
...
boost::condition cv_w;
boost::mutex m_mutex;
volatile std::atomic<bool> needs_work_w, run_w;
